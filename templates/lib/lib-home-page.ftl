...
<#macro facultyMbrHtml>
    <section class="card bg-light  mb-4">
        <h4 class="card-header display-4">${i18n().faculty_capitalized}</h4>
        <div class="card-body">
            <div id="tempSpacing">
...
<#macro allClassGroups classGroups>
    ...
    <#assign classGroupList>
        <section id="home-stats" class="card bg-light mb-4" >
            <h4 class="card-header display-4">${i18n().statistics}</h4>
            <ul id="stats" class="card-body d-flex flex-wrap justify-content-center">
                <#assign groupCount = 1>
                <#list classGroups as group>
                    <#if (groupCount > 6) >
                        <#break/>
...
<#assign foundClassGroup = false />
<section id="home-research" class="card bg-light mb-4">
    <h4 class="card-header display-4">${i18n().research_capitalized}</h4>
    <ul class="card-body">
        <#list classGroups as group>
