...
<div class="d-flex justify-content-center">
    <section id="login" class="hidden">
        <h2 class="text-center text-dark">${i18n().login_button}</h2>
        ...
        <form role="form" id="login-form" action="${formAction}" method="post" name="login-form" />
            <#if externalAuthUrl??>
                ...
                <p class="external-auth"><a class="btn btn-secondary" href="${externalAuthUrl}" title="${i18n().external_auth_name}">${i18n().external_login_text}</a></p>
                <h3 class="text-center mt-2"><b>${i18n().or}</b></h3>
                <h3 class="internal-auth text-center"><!--Log in using your--> 
                    ${siteName} ${i18n().account}
                </h3>
            ...
            <div ${infoClassHide} ${infoClassShow}>
                ...
                <#--  <p class="submit">  -->
                <input name="loginForm" class="btn btn-success float-right mr-4 mt-4" type="submit" value="${i18n().login_button}"/>
                <#--  </p>  -->
...
<div class="d-flex justify-content-center">
    <section id="login">
        <h2 class="text-center text-dark">${i18n().change_password_to_login}</h2>
